...
const ChatBox = ({messageText, sendMessage, updateMessageText}) => {
  return (
    <div className="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
      <div className="relative flex">
         ...
         <input 
            onChange={(e) => updateMessageText(e.currentTarget.value)} value={messageText}
            type="text" placeholder="Write Something" 
            className="w-full focus:outline-none focus:placeholder-gray-400 
            text-gray-600 placeholder-gray-600 pl-12 bg-gray-200 
            rounded-full py-3" />
         ...
         <div className="absolute right-0 items-center inset-y-0 hidden sm:flex">
            ...
            <button 
               ...
               h-12 w-12 transition duration-500 ease-in-out text-white 
