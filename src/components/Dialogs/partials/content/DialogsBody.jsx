...
const DialogsBody = ({messages}) => {
	const dialogsItems = messages.map((dialogsItem, key) => <DialogsItem 
      key={key}
		sender={dialogsItem.sender} 
		message={dialogsItem.message} 
		image={dialogsItem.image}/>
	)
	
  return (
    <div id="messages" className="flex flex-col space-y-4 p-3 max-h-96 
